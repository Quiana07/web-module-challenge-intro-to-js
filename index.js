...
let firstThing = 'test'
let secondThing = 'green'

if(secondThing === "green") {
  firstThing = 'passed';

}
console.log('t1b:', firstThing);
...
console.log('t1c:', Number (birthYear));
...
if (age <1){
  ...
  // feeding conditions for adult dogs
  if (weight <=5 ){
    return weight * .05
  }else if (weight <=10){
    return weight * .04
...
console.log('t4', game('paper', computer));
